...
export default function ProductCard({imageSrc,name,ingredients,price,tags}:ProductCardProps) {
    return (
        <div className='w-full max-w-72 min-w-48 bg-gray-100 rounded-lg p-4'>
            ...
            <div className='w-full flex justify-center items-center gap-12'>
                <button className="bg-orange-400 rounded-xl w-full text-white p-2 mt-2 font-bold">Add to cart</button>
